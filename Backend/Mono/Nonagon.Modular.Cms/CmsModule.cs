...
{
	/// <summary>
	/// The entry point of CMS module.
	/// </summary>
	public class CmsModule : DataModuleBase<CmsInterface>
	{
		protected CmsModule(IDbConnectionFactory dbConnectionFactory) : base(dbConnectionFactory) {}
