...
using Nonagon.Modular.Content.Operations;

namespace Nonagon.Modular.Content
{
	/// <summary>
	/// The functionality interface of Content module.
	/// </summary>
	public class ContentInterface : DataModuleInterface
	{
		public ContentInterface(IDbConnectionFactory dbConnectionFactory)
			: base(dbConnectionFactory) { }

		/// <summary>
		/// Gets the list of contents stored in Content module.
		/// </summary>
